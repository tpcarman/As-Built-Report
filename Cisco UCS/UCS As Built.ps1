...
$Document = Document $Filename -Verbose {
    ...
    if ($Style -eq 'Default') {
        Style -Name 'Title' -Size 24 -Color '005073' -Font 'Arial' -Align Center
        Style -Name 'Title 2' -Size 18 -Color '049FD9' -Font 'Arial' -Align Center
        Style -Name 'Title 3' -Size 12 -Color '049FD9' -Font 'Arial' -Align Left
        Style -Name 'Heading 1' -Size 16 -Color '4D4C4C' -Font 'Arial'
        Style -Name 'Heading 2' -Size 14 -Color '4D4C4C' -Font 'Arial'
        Style -Name 'Heading 3' -Size 12 -Color '4D4C4C' -Font 'Arial'
        Style -Name 'Heading 4' -Size 11 -Color '4D4C4C' -Font 'Arial'
        Style -Name 'Heading 5' -Size 10 -Color '4D4C4C' -Font 'Arial' -Italic
        Style -Name 'H1 Exclude TOC' -Size 16 -Color '4D4C4C' -Font 'Arial'
        Style -Name 'Normal' -Size 10 -Font 'Arial' -Default
        Style -Name 'TOC' -Size 16 -Color '4D4C4C' -Font 'Arial'
        Style -Name 'TableDefaultHeading' -Size 10 -Color 'FFFFFF' -BackgroundColor '464547' -Font 'Arial'
