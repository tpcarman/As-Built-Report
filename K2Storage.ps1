#region Kaminario Storage Document Style
DocumentOption -EnableSectionNumbering -PageSize A4 -DefaultFont 'Arial' -MarginLeftAndRight 71 -MarginTopAndBottom 71

Style -Name 'Title' -Size 24 -Color '1797C0' -Align Center
Style -Name 'Title 2' -Size 18 -Color '2F2F2F' -Align Center
Style -Name 'Title 3' -Size 12 -Color '2F2F2F' -Align Left
Style -Name 'Heading 1' -Size 16 -Color '1797C0' 
Style -Name 'Heading 2' -Size 14 -Color '1797C0' 
Style -Name 'Heading 3' -Size 12 -Color '1797C0' 
Style -Name 'Heading 4' -Size 11 -Color '1797C0' 
Style -Name 'Heading 5' -Size 10 -Color '1797C0' -Italic
Style -Name 'H1 Exclude TOC' -Size 16 -Color '1797C0' 
Style -Name 'Normal' -Size 10 -Default
Style -Name 'TOC' -Size 16 -Color '1797C0' 
Style -Name 'TableDefaultHeading' -Size 10 -Color 'FFFFFF' -BackgroundColor '878787' 
...
#endregion Kaminario Storage Document Style