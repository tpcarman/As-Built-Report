    ...
    Section -Style Heading1 $Arrayname {
        Section -Style Heading2 'System Summary' {
            ...
            Section -Style Heading3 'Storage Summary' {
                $StorageSummary = Get-PfaArraySpaceMetrics $Array | Select-Object @{L = 'Capacity'; E = {"$([math]::Round(($_.capacity) / 1TB, 2)) TB"}}, `
                @{L = 'Used'; E = {"$([math]::Round(($_.total) / 1TB, 2)) TB"}}, @{L = 'Free'; E = {"$([math]::Round(($_.capacity - $_.total) / 1TB, 2)) TB"}}, `
                @{L = '% Used'; E = {"$([math]::Truncate(($_.total / $_.capacity) * 100)) %"}}, @{L = 'Volumes'; E = {"$([math]::Round(($_.volumes) / 1GB, 2)) GB"}}, `
                @{L = 'Snapshots'; E = {"$([math]::Round(($_.snapshots) / 1GB, 2)) GB"}}, @{L = 'Shared Space'; E = {"$([math]::Round(($_.shared_space) / 1GB, 2)) GB"}}, `
                @{L = 'System'; E = {"$([math]::Round(($_.system) / 1GB, 2)) GB"}}, @{L = 'Data Reduction'; E = {[math]::Round(($_.data_reduction), 2)}}, `
        ...
        Section -Style Heading2 'Hardware' {
            ...
            Section -Style Heading3 'Network Configuration' {
                ...
                @{L = 'VLAN'; E = {$_.vlan}}, @{L = 'Speed'; E = {"$(($_.speed) / 1000000000) GB"}}, @{L = 'HW Address'; E = {$_.address}}, `
        ...
        Section -Style Heading2 'Storage' {
            ...
            Section -Style Heading3 'Volumes' {
                ...
                @{L = 'Size'; E = {"$(($_.size) / 1GB) GB"}}, @{L = 'Host Group'; E = {$_.hgroup}}
        ...
        Section -Style Heading2 'Protection' {
            ...
            Section -Style Heading3 'Volume Snapshots (Last 30)' {
                ...
                @{L = 'Source'; E = {$_.source}}, @{L = 'Created'; E = {$_.created}}, @{L = 'Size'; E = {"$(($_.size) / 1GB) GB"}}
