...
<#
.SYNOPSIS  
    PowerShell script to document the configuration of VMware SRM infrastucture in Word/HTML/XML/Text formats
.DESCRIPTION
    Documents the configuration of VMware SRM infrastucture in Word/HTML/XML/Text formats using PScribo.
.NOTES
    Version:        0.1
    Author:         Tim Carman
    Twitter:        @tpcarman
